...
from .views import order, get_order_status, get_order, get_countrys
...
urlpatterns = [
    ...
    path('blog/get/<int:numPage>/<int:qItemsForPage>', get_blog, name=None),
    path('like/set/', set_like, name=None),
    path('blog/detail/<int:id>', get_blog_detail, name=None),

    path('countrys/get/', get_countrys, name=None),
